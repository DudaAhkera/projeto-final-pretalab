        ...
        <>
            ...
            <div className={Styles.squareContainer}>
                ...
                <div className={Styles.Card}>
                    ...
                    <a href=""><img src={card1Img}  alt="Símbolo do microsoft excel" className={Styles.imgCard} /></a>
                </div>
                ...
                <div className={Styles.Card}>
                    ...
                    <a href="https://openbadgefactory.com/v1/assertion/dc3d4c6139c0a23916fb4985eea83b1ce98c6be9.html" ><img src={card2Img} alt="Certificado do curso de Gerenciamento de Projetos" className={Styles.imgCard}  /></a>
                </div>
                <div className={Styles.Card}>
                    <p className={Styles.textCard}>
                    ...
                    <a href="https://www.vapriikki.fi/en/" ><img src={card3Img} alt="Foto tirada em um museu de um mouse e teclado antigos" className={Styles.imgCard} /></a>
                </div>
